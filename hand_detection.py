...
class AskQuestion:
    ...
    def HandAnswer(self):
        ...
        # Creating track bar
        cv2.createTrackbar('h', 'HSV_TrackBar', 0, 179, self.nothing)
        cv2.createTrackbar('s', 'HSV_TrackBar', 0, 255, self.nothing)
        cv2.createTrackbar('v', 'HSV_TrackBar', 0, 255, self.nothing)
